...
using ICategoryService = Nop.Services.Catalog.ICategoryService;
using ICountryService = Nop.Services.Directory.ICountryService;
...
namespace Nop.Web.Areas.Admin.Factories
{
    ...
    public partial class BaseAdminModelFactory : IBaseAdminModelFactory
    {
        ...
        private readonly Services.Zones.ICountryService _hotelCountryService;
        private readonly IProvinceService _hotelProvinceService;
        private readonly ICountyService _hotelCountyService;
        private readonly ICityService _hotelCityService;
        private readonly Services.Hotels.ICategoryService _hotelCategoryService;
        ...
        public BaseAdminModelFactory(ICacheKeyService cacheKeyService,
            ...
            Services.Zones.ICountryService hotelCountryService,
            IProvinceService hotelProvinceService,
            ICityService hotelCityService,
            ICountyService hotelCountyService,
            Services.Hotels.ICategoryService hotelCategoryService,
            IDepartmentService departmentService)
        {
            ...
            _hotelCountryService = hotelCountryService;
            _hotelProvinceService = hotelProvinceService;
            _hotelCountyService = hotelCountyService;
